...
export class ConfirmNlWon<TSubscriber> implements Component {
    E: FrameworkElement;
    ...
    constructor(
        ...
        const boxes = new Boxes(subscriber, 38, icons, '/img/gameplay_events.png', false);
        ...
        this.E = {
            ...
            c: [
                {
                    e: ['h2', 'Please confirm: NL WON the run?']
                },
                boxes,
                {
                    e: ['hr']
                },
                new BackToMainSelection(subscriber, choiceProcessor)
            ]
        }
    }
}
