...
namespace WebsiteTests.Controllers
{
    public class AccountControllerTests
    {
        ...
        public async Task T26()
        {
            ...
            emailService.Verify(x => x.GenerateResetPasswordEmail(It.IsAny<string>(), It.IsAny<string>()), Times.Never);
        }
        ...
        public async Task T29()
        {
            ...
            emailService.Verify(x => x.GenerateResetPasswordEmail(It.IsAny<string>(),  It.IsAny<string>()), Times.Once);
